...
class Adminapi extends Controller
{
    ...
    public function editbankdetail(Request $r)
    {
        ...
        try {
            $bankDetail = Bankdetail::firstOrNew(['id' => 1]);
            ...
            if ($r->hasFile('barcode')) {
                ...
                // Update the barcode field with base64 data
                $bankDetail->barcode = $base64;
            }
            
            // Update other fields
            $bankDetail->account_holder_name = $r->holdername;
            $bankDetail->mobile_no = $r->mobile_no;
            $bankDetail->upi_id = $r->upi_id;
            $bankDetail->account_no = $r->account_no;
            $bankDetail->ifsc_code = $r->ifsccode;
            $bankDetail->bank_name = $r->bank_name;

...
<head>
    ...
    <style>
        ...
        .login-controls.has-error input {
...
<body class="dark-bg-main">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-1">
                    <form class="login-form" method="post" action="#"
                        ...
                        <div class="mb-2">
                            <div id="username-error" class="invalid-feedback" style="display: none; color: #ff5b5b; font-size: 0.8rem;"></div>
                            <div id="password-error" class="invalid-feedback" style="display: none; color: #ff5b5b; font-size: 0.8rem;"></div>
                            <div id="login-error" class="text-danger text-center mb-2" style="display: none; color: #ff5b5b; font-size: 0.9rem; font-weight: 500;"></div>
                        </div>
                    ...
                    <form class="login-form" action="#" method="post" id="resetPasswordForm">
                        ...
                        <div class="login-controls">
                            <label for="reset_password">
                                ...
                                <input type="password" class="form-control" id="reset_password" placeholder="Password"
                        ...
                        <div>
                            <label id="reset_confirm_password-error" class="error" for="reset_confirm_password"></label>
    ...
    <script src="{{ asset('user/js/password-update.js') }}"></script>
    @yield('js')
</body>

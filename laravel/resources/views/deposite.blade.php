                ...
                <div class="col-md-6">
                    ...
                    <div class="pay-static-form text-white fw-bold">
                        ...
                        <div class="white-box mt-3 text-center">
                            @php
                                $bankDetails = \App\Models\Bankdetail::first();
                                $qrCodeData = $bankDetails->barcode ?? null;
                            @endphp
                            @if($qrCodeData)
                                <img src="{{ $qrCodeData }}" class="barcode-img" id="barcode" style="max-width: 200px; height: auto;" onerror="this.onerror=null; this.src='{{ asset('images/barcode.png') }}';"/>
                            @else
                                <img src="{{ asset('images/barcode.png') }}" class="barcode-img" id="barcode"/>
                            @endif
